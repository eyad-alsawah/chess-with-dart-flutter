...
List<Map<String, dynamic>> getPawnPieces(
  ...
  if (currentPiece['type'] == PieceTypeT.light) {
    //top-right
    (file != Files.h && rank != 8)
  ...
  } else if (currentPiece['type'] == PieceTypeT.dark) {
    //bottom-right
    (file != Files.h && rank != 1)
        ? pawnPieces.add(chessBoard[currentIndex - 7])
        : null;
